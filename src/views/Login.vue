      ...
      if (this.checkEmail()) {
        ...
        AdminLogin(type, this.form).then((res) => {
          ...
          if (res.status) {
            ...
            this.$store.commit('user/saveAccess', res.data.access);
            setTimeout(() => {
              let access = sessionStorage.getItem("access")
              if (access == 0) { this.$router.push("/admin/admin"); console.log("Access:"+0) }
              else if(access == 1) { this.$router.push("/user/sale/create"); console.log("Access:"+1) }
              else if(access == 2) { this.$router.push("/shopuser/sale/create"); console.log("Access:"+2) }
              else{this.$router.push("/shopuser/sale/create"); console.log("Access"+access)}
...
<style scoped>
@import "@/views/user/motion/pre.css";
body {
