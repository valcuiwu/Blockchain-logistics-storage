<template>
  ...
  <!--     <div>
      ...
      <div>
        ...
        <a-button class="btn" @click="emailVisible = true" type="link">修改</a-button>
        <p class="des">用户姓名： 张三</p>
        <a-divider/>
      </div>
<!--       <div>
        <a class="item-title" type="link">电话号码</a>
        <a-button class="btn" @click="emailVisible = true" type="link">修改</a-button>
        <p class="des">电话号码 123456</p>
        <a-divider/>
      </div> -->
      <div>
        <a class="item-title" type="link">当前用户身份</a>
        <!-- <a-button class="btn"  type="link">修改</a-button> -->
        <p class="authority">{{ identity }}</p>
        <a-divider/>
      </div>
    </a-spin>
