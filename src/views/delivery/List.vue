<template>
  <div class="List-box">
    <a-table :loading="loading" :columns="columns" :data-source="data1" bordered rowKey="id">
...
export default {
  data() {
    return {
      data: [{ driver: '司机A', number: '苏J5224', time: '2023-8-21 20:10:23', phone: '123456', status: 0, address: '江苏省南京市江宁区XXX' },
      { driver: '司机A', number: '苏E4545', phone: '12323232', time: '2023-8-21 20:27:43', status: 1, address: '江苏省镇江市丹徒区XXXX' }],
      data1: [{ driver: '司机B', number: '闽B2555', phone: '1234513', time: '2023-8-21 20:28:05', status: 0, address: '福建省福州市晋安区XXX' },
      { driver: '司机B', number: '闽B3522', phone: '1234513', time: '2023-8-21 20:28:23', status: 1, address: '福建省泉州市南安市XXX' },
      { driver: '司机B', number: '浙A5215', phone: '1234513', time: '2023-8-21 20:28:40', status: 2, address: '福建省宁德市屏南县XXX' }],
      select: {},
      loading: false,
      form: {
        cacheData: [],
  ...
  methods: {
    ...
    edit(id) {
      ...
      this.data[id].status = this.data[id].status + 1;
    ...
    review(index) {
      ...
      this.visible2 = true
      // this.data[index].status = this.data[index].status + 1;
